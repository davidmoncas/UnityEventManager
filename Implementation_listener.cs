...
public class Implementation_listener : MonoBehaviour
{
    ...
    private void OnEnable()
    {
        ...
        EventManager.Subscribe(Events.Gameplay.Event1, (System.Action<int>)SomeMethod2);
        EventManager.Subscribe(Events.Gameplay.Event1, (System.Action<int , string>)SomeMethod3);
    }
    ...
    private void OnDisable()
    {
        ...
        EventManager.Unsubscribe(Events.Gameplay.Event1, (System.Action<int>)SomeMethod2);
        EventManager.Unsubscribe(Events.Gameplay.Event1, (System.Action<int, string>)SomeMethod3);
    }
}
